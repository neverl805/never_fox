...
// Not in the bindgen allowlist; declared manually (symbol lives in libssl3).
unsafe extern "C" {
    pub fn SSL_SignatureSchemePrefSet(
        fd: *mut PRFileDesc,
        schemes: *const SSLSignatureScheme::Type,
        count: c_uint,
    ) -> SECStatus;
}
